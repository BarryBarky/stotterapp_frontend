export default function stutterRec() {
        ...
        if (!(navigator.mediaDevices && navigator.mediaDevices.getUserMedia)) {
            ...
            return navigator.mediaDevices.getUserMedia({ audio: true }/*of type MediaStreamConstraints*/)
                ...
                .then(stream /*of type MediaStream*/ => {
                    ...
                    audioRecorder.mediaRecorder.start(parseInt(document.querySelector('#blob-lenght').value));
                });
    ...
    stop: function () {
        ...
        return new Promise(resolve => {
            ...
            audioRecorder.mediaRecorder.addEventListener("stop", () => {
              console.log('nr of blobs = ' + audioRecorder.audioBlobs.length);
              
              console.log('blobs = ' + audioRecorder.audioBlobs);
...
              for (var i=0; i < audioRecorder.audioBlobs.length; i++) {
                
    newAudioBlobs.push(audioRecorder.audioBlobs[i]);
                if(i===10 || i=== (10 + counter)){
                  
newAudioBlobs.push(audioRecorder.audioBlobs[i]);     newAudioBlobs.push(audioRecorder.audioBlobs[i]);
                  counter = counter + parseInt(document.querySelector('#frame-lenght').value);
                ...
                let audioBlob = new Blob(newAudioBlobs, { type: mimeType });
